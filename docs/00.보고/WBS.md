...
| 린트 층 Phase 4 규칙 확장 (R4~R8) | P6-07~11 | R4/R5 **완료**, R6~R8 대기 | P6-07/08 04-10 완료 |
...
| ID    | 태스크                            | 비고                              |
| ----- | --------------------------------- | --------------------------------- |
| **P5-28b** | **VB 개선 재검증**           | 진행 중 — 04-10~04-14 로그 누적 → 04-15 재집계 |
| P6-09 | R6: async ccxt fetch_* 누락 await | 목표 04-17                         |
| P6-10 | R7: 상태 파일 fetch_balance 교차검증 | 목표 04-17                      |
| P6-11 | R8: 시장가 주문 후 sleep 없는 fetch_order | 목표 04-17                  |
