...
### 다음 주 (04-20 ~ 04-26, W17)

| 목표 | WBS ID | 상태 | 비고 |
|------|--------|------|------|
| P6-13 lint_history.jsonl 누적 + 주간 통계 | P6-13 | 대기 | 04-27 목표 |
| VB 샘플 수집 모니터링 (상승장 복귀 대기) | P5-28b 후속 | 조건부 | BTC>EMA200 7일 충족 시 자동 재집계 |
| P5-02 VB 파라미터 최적화 | P5-02 | 대기 | VB 거래 재개 후 착수 (현재는 하락장으로 보류) |
| P5-03 알트 펌프 서핑 재검토 | P5-03 | 대기 | 04-13~17 목표 지연 → 상승장 복귀 시 |
| P5-04 레짐 자동 전환 시스템 | P5-04 | 대기 | 04-13~17 목표 지연 → 우선순위 상향 예정 |
