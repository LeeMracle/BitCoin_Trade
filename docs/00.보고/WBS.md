...
| Phase 4 실전거래        | 0    | 0    | 16   | 16   |
| Phase 5 전략고도화      | 4    | 0    | 23   | 27   |
...
| **VB 개선 A~E (하락장필터 외 4건)** | P5-28 | 대기 | 04-10 ~ 04-14 구현 → 04-15 재검증 |
...
| ID    | 태스크                            | 비고                              |
| ----- | --------------------------------- | --------------------------------- |
| **P5-28** | **VB 개선 A~E 구현**              | P4-06 NO-GO 결정(04-09) 후속, 04-15 재검증 목표 |
| -     | CB L2 AWS scp 배포                | 로컬 검증 완료(04-09), 서버 반영만 남음 |
